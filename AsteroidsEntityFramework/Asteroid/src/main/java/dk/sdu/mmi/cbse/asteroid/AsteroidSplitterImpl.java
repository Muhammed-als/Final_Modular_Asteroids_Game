...
public class AsteroidSplitterImpl implements IAsteroidSplitter {
    ...
    public void createSplitAsteroid(Entity e, World world) {
        ...
        Entity asteroid2 = new Asteroid();
        astroid1.setRadius(radius);
        asteroid2.setRadius(radius);
        astroid1.add(new MovingPart(movingPart.getDeceleration(),movingPart.getAcceleration(), speed,0));
        asteroid2.add(new MovingPart(movingPart.getDeceleration(),movingPart.getAcceleration(),speed,0));
        astroid1.add(new PositionPart(x, y,radians));
        asteroid2.add(new PositionPart(x, y,radians));
        astroid1.add(new LifePart(life));
        asteroid2.add(new LifePart(life));
